...
| LLM | Kimi (Moonshot) | Kimi (Moonshot) |
...
| `LLM_API_KEY` | Yes | Kimi/Moonshot API key |
| `LLM_BASE_URL` | No | LLM endpoint (default: moonshot) |
| `LLM_MODEL` | No | Model name (default: moonshot-v1-128k) |
...
- **Library**: Paper collection with manual PDF upload
- **Paper Workspace**: PDF viewer with text selection comments
